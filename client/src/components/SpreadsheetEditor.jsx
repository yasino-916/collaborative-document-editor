    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-4 py-2 border-b border-gray-200">
        <div className="flex items-center flex-1">
          ...
          <div className="w-10 h-10 bg-green-100 rounded-md flex items-center justify-center mr-3 flex-shrink-0">
          ...
          <div className="flex flex-col">
            <h1 className="text-lg font-medium text-gray-800 leading-tight">{document?.title || 'Untitled spreadsheet'}</h1>
            <div className="flex items-center text-sm text-gray-500 space-x-3 mt-1">
              ...
              <button className="hover:bg-gray-100 px-2 py-0.5 rounded cursor-pointer">Data</button>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-[#C2E7FF] hover:bg-[#B3DDF8] text-[#001D35] px-6 py-2 rounded-full font-medium flex items-center transition-colors">
            <Share size={18} className="mr-2" /> Share
          </button>
          
          <div className="w-9 h-9 rounded-full bg-green-500 text-white flex items-center justify-center font-medium shadow-sm">
